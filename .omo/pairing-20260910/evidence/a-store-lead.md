...
Lead diagnostics attempted on `erd-app/src/pairing.rs`: unavailable because the shared LSP daemon is unreachable. Remote compilation in the command above passed.
