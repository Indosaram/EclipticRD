---
name: eclipticrd-remote-control
description: Use EclipticRD MCP tools to inspect and control a paired remote desktop through screenshots, mouse input, keyboard input, and explicit input release.
---

# EclipticRD remote control

## Prerequisite

The agent environment must expose the EclipticRD MCP server, launched as:
